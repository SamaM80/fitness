...
class WorkoutTrakerView extends StatefulWidget {
  const WorkoutTrakerView({super.key});

  @override
  State<WorkoutTrakerView> createState() => _WorkoutTrakerViewState();
}

class _WorkoutTrakerViewState extends State<WorkoutTrakerView> {
  List latestArr = [
    {
                  ...
                  LineChartData(
                    ...
                    gridData: FlGridData(
                      ...
                      getDrawingHorizontalLine: (value) {
                        return FlLine(
                          color: Tcolor.white.withAlpha(80),
                          strokeWidth: 2,
                        );
                      },
                    ),
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
    isCurved: true,
    color: Tcolor.white.withAlpha(100),
    barWidth: 4,
    isStrokeCapRound: true,
    dotData: FlDotData(show: false),
    belowBarData: BarAreaData(show: false),
